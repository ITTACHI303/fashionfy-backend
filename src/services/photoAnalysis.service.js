...
class PhotoAnalysisService {
  ...
  // static async analyzePhoto(userId, imageFrontPath, imageSidePath, heightCm) {
  //   const form = new FormData();

  //   // Add files with EXACT field names
  //   form.append('image_front', fs.createReadStream(imageFrontPath), {
  //     filename: 'front.png',
  //     contentType: 'image/png'
  //   });

  //   form.append('image_side', fs.createReadStream(imageSidePath), {
  //     filename: 'side.png',
  //     contentType: 'image/png'
  //   });

  //   // Add height_cm as a query parameter in the URL
  //   const pythonApiUrl = `http://localhost:8000/ema?height_cm=172`;
